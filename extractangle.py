	...
	for line in input: 
		...
		if len(d)>1:
			...
			if switch == 1:
				if important_oxygen_name == d[1] and important_oxygen_definition == d[2]:
					#print d[3]
					cu_o_bond_dist19.append(float(d[3]))
				if d[0]=="SCF" and d[1]=="Done:" and d[2]=="E(UB3LYP)" and d[3]=="=":
					#print d[4]
					QM_energy19.append(float(d[4]) * 627.503) 
				if d[0]=="Standard" and d[1]=="orientation:":
					count += 1
				if count==1:
					count2 += 1
...
first_element_in_qm_energy19 = QM_energy19[0]
for i in range(len(QM_energy19)):
	QM_energy19[i] -= first_element_in_qm_energy1




plt.grid(b=True, which='major', axis='both', color='#808080', linestyle='--')
plt.plot(cu_o_bond_dist1[1:5], QM_energy1[0:4], "g^")
plt.plot(cu_o_bond_dist2[1:5], QM_energy2[0:4], "b^")
plt.plot(cu_o_bond_dist3[1:25], QM_energy3[0:24], "r^")
plt.plot(cu_o_bond_dist4[1:25], QM_energy4[0:24], "k^")
plt.plot(cu_o_bond_dist5[1:25], QM_energy5[0:24], "m^")
plt.plot(cu_o_bond_dist6[1:25], QM_energy6[0:24], "gs")
plt.plot(cu_o_bond_dist7[1:25], QM_energy7[0:24], "bs")
plt.plot(cu_o_bond_dist8[1:25], QM_energy8[0:24], "rs")
plt.plot(cu_o_bond_dist9[1:25], QM_energy9[0:24], "ks")
plt.plot(cu_o_bond_dist10[1:25], QM_energy10[0:24], "ms")
plt.plot(cu_o_bond_dist11[1:25], QM_energy11[0:24], "go")
plt.plot(cu_o_bond_dist12[1:25], QM_energy12[0:24], "bo")
plt.plot(cu_o_bond_dist13[1:25], QM_energy13[0:24], "ro")
plt.plot(cu_o_bond_dist14[1:25], QM_energy14[0:24], "ko")
plt.plot(cu_o_bond_dist15[1:25], QM_energy15[0:24], "mo")
plt.plot(cu_o_bond_dist16[1:25], QM_energy16[0:24], "g+")
plt.plot(cu_o_bond_dist17[1:25], QM_energy17[0:24], "b+")
plt.plot(cu_o_bond_dist18[1:25], QM_energy18[0:24], "r+")
plt.plot(cu_o_bond_dist19[1:25], QM_energy19[0:24], "k+")

plt.legend([angle_scanned1, angle_scanned2, angle_scanned3, angle_scanned4, angle_scanned5, angle_scanned6, angle_scanned7, angle_scanned8, angle_scanned9, angle_scanned10, angle_scanned11, angle_scanned12, angle_scanned13, angle_scanned14, angle_scanned15, angle_scanned16, angle_scanned17, angle_scanned18, angle_scanned19], fontsize='10', bbox_to_anchor=(1, .2, 0.25, 0.0), loc=3, ncol=1, mode='expand', borderaxespad=0., numpoints = 1)
...
plt.title(r'Angle Scan 90-180 2-Water System', size='14')
